...
<head>
    ...
    <title>Bread Factory Admin - Iniciar sesión</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../pos/login.php">POS</a>
                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <h3 class="mb-3">Iniciar sesión (Administrador)</h3>
                        ...
                        <div class="row">
                            <div class="col-md-7 pe-0">
                                <div class="form-left h-100 py-5 px-5">
                                    <form action="" class="row g-4" id="loginForm" autocomplete="off">
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-secondary px-4 float-end mt-4" id="btnLogin">Iniciar
                                                sesión</button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="col-md-5 ps-0 d-none d-md-block">
                                <div class="form-right h-100 bg-secondary text-white text-center pt-5">
                                    <img src="../pos/images/company_logo.png" style="width: 150px;" class="img-fluid" />
